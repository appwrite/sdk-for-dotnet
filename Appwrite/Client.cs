    ...
    public class Client
    {
            ...
            HttpClient? httpForRedirect = null)
        {
            ...
            _headers = new Dictionary<string, string>()
            {
                ...
                { "user-agent" , "AppwriteDotNetSDK/0.11.1 (${Environment.OSVersion.Platform}; ${Environment.OSVersion.VersionString})"},
                { "x-sdk-name", ".NET" },
                { "x-sdk-platform", "server" },
                { "x-sdk-language", "dotnet" },
                { "x-sdk-version", "0.11.1"},                { "X-Appwrite-Response-Format", "1.6.0" }
            };
