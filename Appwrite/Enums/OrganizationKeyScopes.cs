...
namespace Appwrite.Enums
{
    public class OrganizationKeyScopes : IEnum
    {
        ...
        public static OrganizationKeyScopes OrganizationInstallationsRead => new OrganizationKeyScopes("organization.installations.read");
        public static OrganizationKeyScopes OrganizationInstallationsWrite => new OrganizationKeyScopes("organization.installations.write");
