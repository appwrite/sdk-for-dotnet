...
namespace Appwrite.Models
{
    public class UsageBillingPlan
    {
        ...
        public static UsageBillingPlan From(Dictionary<string, object> map) => new UsageBillingPlan(
            ...
            member: Appwrite.Models.AdditionalResource.From(map: map["member"] is JsonElement jsonObj3 ? jsonObj3.Deserialize<Dictionary<string, object>>()! : (Dictionary<string, object>)map["member"]),
            ...
            realtimeBandwidth: Appwrite.Models.AdditionalResource.From(map: map["realtimeBandwidth"] is JsonElement jsonObj6 ? jsonObj6.Deserialize<Dictionary<string, object>>()! : (Dictionary<string, object>)map["realtimeBandwidth"]),
            ...
            credits: Appwrite.Models.AdditionalResource.From(map: map["credits"] is JsonElement jsonObj11 ? jsonObj11.Deserialize<Dictionary<string, object>>()! : (Dictionary<string, object>)map["credits"])
        );
