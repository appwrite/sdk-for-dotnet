...
namespace Appwrite
{
    public class Query
    {
        ...
        /// </summary>
        /// <remarks>For array attributes, use <see cref="ContainsAny"/> or <see cref="ContainsAll"/> instead.</remarks>
        ...
        /// </summary>
        public static string ContainsAny(string attribute, IList value) {
            return new Query("containsAny", attribute, value).ToString();
        }
        ...
        /// </summary>
        public static string ContainsAll(string attribute, IList value) {
            return new Query("containsAll", attribute, value).ToString();
        }
