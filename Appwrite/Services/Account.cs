...
namespace Appwrite.Services
{
    public class Account : Service
    {
        ...
        /// </para>
        /// </summary>
        public Task<Models.KeyList> ListKeys(bool? total = null)
        {
            var apiPath = "/account/keys";
        ...
        /// </para>
        /// </summary>
        public Task<Models.Key> CreateKey(string name, List<Appwrite.Enums.Scopes> scopes, string? expire = null)
        {
            var apiPath = "/account/keys";
        ...
        {
            var apiPath = "/account/keys/{keyId}"
                .Replace("{keyId}", keyId);
