...
namespace Appwrite.Services
{
    public class DocumentsDB : Service
    {
        ...
        {
            var apiPath = "/documentsdb/specifications";
        ...
        {
            var apiPath = "/documentsdb/{databaseId}"
        ...
        {
            var apiPath = "/documentsdb/{databaseId}/collections"
                .Replace("{databaseId}", databaseId);
        ...
        {
            var apiPath = "/documentsdb/{databaseId}/collections/{collectionId}"
                .Replace("{databaseId}", databaseId)
        ...
        /// </para>
        /// </summary>
        public Task<Models.Collection> UpdateCollection(string databaseId, string collectionId, string name, List<string>? permissions = null, bool? documentSecurity = null, bool? enabled = null, bool? purge = null)
        {
            var apiPath = "/documentsdb/{databaseId}/collections/{collectionId}"
                .Replace("{databaseId}", databaseId)
                .Replace("{collectionId}", collectionId);
        ...
        {
            var apiPath = "/documentsdb/{databaseId}/collections/{collectionId}/indexes"
                .Replace("{databaseId}", databaseId)
                .Replace("{collectionId}", collectionId);
        ...
        /// </para>
        /// </summary>
        public Task<Models.Index> CreateIndex(string databaseId, string collectionId, string key, Appwrite.Enums.DocumentsDBIndexType type, List<string> attributes, List<Appwrite.Enums.OrderBy>? orders = null, List<long>? lengths = null)
        {
            var apiPath = "/documentsdb/{databaseId}/collections/{collectionId}/indexes"
                .Replace("{databaseId}", databaseId)
                .Replace("{collectionId}", collectionId);
        ...
        {
            var apiPath = "/documentsdb/{databaseId}/collections/{collectionId}/indexes/{key}"
                .Replace("{databaseId}", databaseId)
                .Replace("{collectionId}", collectionId)
                .Replace("{key}", key);
        ...
        {
            var apiPath = "/documentsdb/{databaseId}/failovers"
                .Replace("{databaseId}", databaseId);
        ...
        {
            var apiPath = "/documentsdb/{databaseId}/operations"
                .Replace("{databaseId}", databaseId);
        ...
        {
            var apiPath = "/documentsdb/{databaseId}/replicas"
                .Replace("{databaseId}", databaseId);
        ...
        {
            var apiPath = "/documentsdb/{databaseId}/status"
                .Replace("{databaseId}", databaseId);
