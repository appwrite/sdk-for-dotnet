...
namespace Appwrite.Services
{
    public class Health : Service
    {
        ...
        /// </para>
        /// </summary>
        public Task<Models.HealthStatusList> GetAuditsDB()
        {
            var apiPath = "/health/audits-db";
        ...
        /// </para>
        /// </summary>
        public Task<Models.HealthQueue> GetFailedJobs(Appwrite.Enums.HealthQueueName name, long? threshold = null)
        {
