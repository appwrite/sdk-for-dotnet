...
namespace Appwrite.Services
{
    public class Proxy : Service
    {
        ...
        /// </para>
        /// </summary>
        public Task<Models.ProxyRuleList> ListRules(List<string>? queries = null, bool? total = null)
        {
            ...
            {
                return Models.ProxyRuleList.From(map: it);
            }
        ...
        public Task<Models.ProxyRule> CreateAPIRule(string domain)
        {
            ...
            {
                return Models.ProxyRule.From(map: it);
            }
        ...
        /// </para>
        /// </summary>
        public Task<Models.ProxyRule> UpdateRuleStatus(string ruleId)
        {
            var apiPath = "/proxy/rules/{ruleId}/status"
                .Replace("{ruleId}", ruleId);
