...
{
    public class Tables : Service
    {
        public Tables(Client client) : base(client)
        {
        }
        ...
        /// </para>
        /// </summary>
        public Task<Models.TableList> List(string databaseId, List<string>? queries = null, string? search = null)
        {
            var apiPath = "/databases/{databaseId}/tables"
        ...
        /// </para>
        /// </summary>
        public Task<Models.Table> Create(string databaseId, string tableId, string name, List<string>? permissions = null, bool? rowSecurity = null, bool? enabled = null)
        {
            var apiPath = "/databases/{databaseId}/tables"
                .Replace("{databaseId}", databaseId);
        ...
        /// </para>
        /// </summary>
        public Task<Models.Table> Get(string databaseId, string tableId)
        {
            var apiPath = "/databases/{databaseId}/tables/{tableId}"
                .Replace("{databaseId}", databaseId)
        ...
        /// </para>
        /// </summary>
        public Task<Models.Table> Update(string databaseId, string tableId, string name, List<string>? permissions = null, bool? rowSecurity = null, bool? enabled = null)
        {
            var apiPath = "/databases/{databaseId}/tables/{tableId}"
                .Replace("{databaseId}", databaseId)
                .Replace("{tableId}", tableId);
        ...
        /// </para>
        /// </summary>
        public Task<object> Delete(string databaseId, string tableId)
        {
            var apiPath = "/databases/{databaseId}/tables/{tableId}"
                .Replace("{databaseId}", databaseId)
                .Replace("{tableId}", tableId);
        ...
        {
            var apiPath = "/databases/{databaseId}/tables/{tableId}/columns"
                .Replace("{databaseId}", databaseId)
                .Replace("{tableId}", tableId);
        ...
        {
            var apiPath = "/databases/{databaseId}/tables/{tableId}/columns/boolean"
                .Replace("{databaseId}", databaseId)
                .Replace("{tableId}", tableId);
        ...
        {
            var apiPath = "/databases/{databaseId}/tables/{tableId}/columns/boolean/{key}"
                .Replace("{databaseId}", databaseId)
                .Replace("{tableId}", tableId)
                .Replace("{key}", key);
        ...
        {
            var apiPath = "/databases/{databaseId}/tables/{tableId}/columns/datetime"
                .Replace("{databaseId}", databaseId)
                .Replace("{tableId}", tableId);
        ...
        {
            var apiPath = "/databases/{databaseId}/tables/{tableId}/columns/datetime/{key}"
                .Replace("{databaseId}", databaseId)
                .Replace("{tableId}", tableId)
                .Replace("{key}", key);
        ...
        {
            var apiPath = "/databases/{databaseId}/tables/{tableId}/columns/email"
                .Replace("{databaseId}", databaseId)
                .Replace("{tableId}", tableId);
        ...
        {
            var apiPath = "/databases/{databaseId}/tables/{tableId}/columns/email/{key}"
                .Replace("{databaseId}", databaseId)
                .Replace("{tableId}", tableId)
                .Replace("{key}", key);
        ...
        {
            var apiPath = "/databases/{databaseId}/tables/{tableId}/columns/enum"
                .Replace("{databaseId}", databaseId)
                .Replace("{tableId}", tableId);
        ...
        {
            var apiPath = "/databases/{databaseId}/tables/{tableId}/columns/enum/{key}"
                .Replace("{databaseId}", databaseId)
                .Replace("{tableId}", tableId)
                .Replace("{key}", key);
        ...
        {
            var apiPath = "/databases/{databaseId}/tables/{tableId}/columns/float"
                .Replace("{databaseId}", databaseId)
                .Replace("{tableId}", tableId);
        ...
        {
            var apiPath = "/databases/{databaseId}/tables/{tableId}/columns/float/{key}"
                .Replace("{databaseId}", databaseId)
                .Replace("{tableId}", tableId)
                .Replace("{key}", key);
        ...
        {
            var apiPath = "/databases/{databaseId}/tables/{tableId}/columns/integer"
                .Replace("{databaseId}", databaseId)
                .Replace("{tableId}", tableId);
        ...
        {
            var apiPath = "/databases/{databaseId}/tables/{tableId}/columns/integer/{key}"
                .Replace("{databaseId}", databaseId)
                .Replace("{tableId}", tableId)
                .Replace("{key}", key);
        ...
        {
            var apiPath = "/databases/{databaseId}/tables/{tableId}/columns/ip"
                .Replace("{databaseId}", databaseId)
                .Replace("{tableId}", tableId);
        ...
        {
            var apiPath = "/databases/{databaseId}/tables/{tableId}/columns/ip/{key}"
                .Replace("{databaseId}", databaseId)
                .Replace("{tableId}", tableId)
                .Replace("{key}", key);
        ...
        {
            var apiPath = "/databases/{databaseId}/tables/{tableId}/columns/relationship"
                .Replace("{databaseId}", databaseId)
                .Replace("{tableId}", tableId);
        ...
        {
            var apiPath = "/databases/{databaseId}/tables/{tableId}/columns/string"
                .Replace("{databaseId}", databaseId)
                .Replace("{tableId}", tableId);
        ...
        {
            var apiPath = "/databases/{databaseId}/tables/{tableId}/columns/string/{key}"
                .Replace("{databaseId}", databaseId)
                .Replace("{tableId}", tableId)
                .Replace("{key}", key);
        ...
        {
            var apiPath = "/databases/{databaseId}/tables/{tableId}/columns/url"
                .Replace("{databaseId}", databaseId)
                .Replace("{tableId}", tableId);
        ...
        {
            var apiPath = "/databases/{databaseId}/tables/{tableId}/columns/url/{key}"
                .Replace("{databaseId}", databaseId)
                .Replace("{tableId}", tableId)
                .Replace("{key}", key);
        ...
        {
            var apiPath = "/databases/{databaseId}/tables/{tableId}/columns/{key}"
                .Replace("{databaseId}", databaseId)
                .Replace("{tableId}", tableId)
                .Replace("{key}", key);
        ...
        {
            var apiPath = "/databases/{databaseId}/tables/{tableId}/columns/{key}/relationship"
                .Replace("{databaseId}", databaseId)
                .Replace("{tableId}", tableId)
                .Replace("{key}", key);
        ...
        {
            var apiPath = "/databases/{databaseId}/tables/{tableId}/indexes"
                .Replace("{databaseId}", databaseId)
                .Replace("{tableId}", tableId);
        ...
        {
            var apiPath = "/databases/{databaseId}/tables/{tableId}/indexes/{key}"
                .Replace("{databaseId}", databaseId)
                .Replace("{tableId}", tableId)
                .Replace("{key}", key);
        ...
        {
            var apiPath = "/databases/{databaseId}/tables/{tableId}/rows"
                .Replace("{databaseId}", databaseId)
                .Replace("{tableId}", tableId);
        ...
        /// </para>
        /// </summary>
        public Task<Models.RowList> UpsertRows(string databaseId, string tableId)
        {
            var apiPath = "/databases/{databaseId}/tables/{tableId}/rows"
                .Replace("{databaseId}", databaseId)
                .Replace("{tableId}", tableId);
        ...
        {
            var apiPath = "/databases/{databaseId}/tables/{tableId}/rows/{rowId}"
                .Replace("{databaseId}", databaseId)
                .Replace("{tableId}", tableId)
                .Replace("{rowId}", rowId);
        ...
        /// </para>
        /// </summary>
        public Task<Models.Row> UpsertRow(string databaseId, string tableId, string rowId)
        {
            var apiPath = "/databases/{databaseId}/tables/{tableId}/rows/{rowId}"
                .Replace("{databaseId}", databaseId)
                .Replace("{tableId}", tableId)
        ...
        {
            var apiPath = "/databases/{databaseId}/tables/{tableId}/rows/{rowId}/{column}/decrement"
                .Replace("{databaseId}", databaseId)
                .Replace("{tableId}", tableId)
                .Replace("{rowId}", rowId)
        ...
        {
            var apiPath = "/databases/{databaseId}/tables/{tableId}/rows/{rowId}/{column}/increment"
                .Replace("{databaseId}", databaseId)
                .Replace("{tableId}", tableId)
                .Replace("{rowId}", rowId)
                .Replace("{column}", column);
