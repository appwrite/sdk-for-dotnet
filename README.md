...
**This SDK is compatible with Appwrite server version 1.6.x. For older versions, please check [previous releases](https://github.com/appwrite/sdk-for-dotnet/releases).**
...
```xml
<PackageReference Include="Appwrite" Version="0.9.0-rc.1" />
```
...
```powershell
# Package Manager
Install-Package Appwrite -Version 0.9.0-rc.1

# or .NET CLI
dotnet add package Appwrite --version 0.9.0-rc.1
```
